...
public class FilmDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        film = intent.getExtras().getParcelable(FilmAdapter.EXTRA_FILM);
        ...
        tvTireOriginal.setText(film.getTitleOriginal());
    ...
    void favoris(View v)
    {
        buttonFav.setVisibility(View.INVISIBLE);
        buttonFavOk.setVisibility(View.VISIBLE);
        statics.mesFilmsFavoris = getPreferences(MODE_PRIVATE );
        SharedPreferences.Editor favEditor = statics.mesFilmsFavoris.edit();
        Gson gson = new Gson();
    ...
    void favorisSupr(View v)
    {
        ...
        if(statics.mesFilmsFavoris!=null) {
            ...
            while (it.hasNext()) {
                ...
                Film movie = gson.fromJson((String) ob, Film.class);
                if(movie.getId()==film.getId()){
                    statics.mesFilmsFavoris.edit().remove(film.getId()+"").commit();
